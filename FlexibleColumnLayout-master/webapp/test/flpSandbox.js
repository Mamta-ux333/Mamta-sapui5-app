		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "FLC POC",
									"targetURL": "#flexiblecolumnlayout-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"flexiblecolumnlayout-display": {
								"semanticObject": "flexiblecolumnlayout",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=flexiblecolumnlayout",
									"url": sap.ui.require.toUrl("flexiblecolumnlayout")
								}
							}
						}
					}
